...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% cell # definition
sleep_hours = 6; % Average number of hours the person sleeps
N = zeros(t,1);
M = zeros(t,1);
EC = zeros(t,1);
...
for n = 1:m
    if rem(n,24) == 1
        sleeping_hrs = 2+randi(8);
    end
    
    if rem(n,24)< 24 - sleeping_hrs
    ...
    if n==113500 | n == 114500 | n == 115500
        disp(C1(n,1)); disp(C2(n,1)); disp(C3(n,1));
        disp(C4(n,1)); disp(C5(n,1)); disp(C6(n,1)); 
        disp(C9(n,1)); disp(C10(n,1));
    end
end
